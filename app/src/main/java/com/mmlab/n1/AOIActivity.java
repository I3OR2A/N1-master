...
public class AOIActivity extends AppCompatActivity implements TaskCompleted {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final LOIModel item = getIntent().getParcelableExtra("AOI-Content");
		...
		mRecyclerView.setAdapter(new LOISequenceAdapter(this, aoiSequenceList));
	}
	...
	public void onTaskComplete(String response, String type) {
		if (type.equals("IP")) {
			...
			if (type.equals("LOI-Sequence")) {
				...
				mAdapter = new LOISequenceAdapter(this, aoiSequenceList);
				mRecyclerView.setHasFixedSize(true);
				mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
